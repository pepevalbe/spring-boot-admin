...
<template>
  <div class="border-t-4 rounded-b px-4 py-3 shadow-md backdrop-filter backdrop-blur-xs bg-opacity-80" :class="classNamesUtil(alertClass, classNames)" role="alert" v-if="hasError">
    <div class="flex">
      <div class="py-1">
